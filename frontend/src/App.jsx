...
// Import the NEW PaymentGateway (Old Payment is removed)
import PaymentGateway from './pages/PaymentGateway';

/**
 * Decodes the JWT token payload to extract user role.
 * Falls back to localStorage 'role' or defaults to 'audience'.
 */
...
/**
 * Limits access to users with 'admin' or 'support' role.
 */
  ...
  return (
    <Router>
      ...
      <Routes>
        ...
        {/* FIX: Removed duplicate old Payment route, using new Gateway */}
        <Route 
